...
const routes: Routes = [
  ...
  { path: 'records', component: PortalPageComponent, data: { pageKey: 'records' } },
  { path: 'pensions', component: PortalPageComponent, data: { pageKey: 'benefits' } },
  { path: 'benefits', component: PortalPageComponent, data: { pageKey: 'benefits' } },
  { path: 'insurance', component: PortalPageComponent, data: { pageKey: 'insurance' } },
  { path: 'funerals', component: PortalPageComponent, data: { pageKey: 'funerals' } },
  { path: 'employment', component: PortalPageComponent, data: { pageKey: 'employment' } },
  { path: 'welfare', component: PortalPageComponent, data: { pageKey: 'welfare' } },
